...
namespace HotelProject.WebUI.Controllers
{
    public class ContactController : Controller
    {
        ...
        public async Task<IActionResult> SendMessage(CreateContactDto createContactDto)
        {
            ...
            var jsonData = JsonConvert.SerializeObject(createContactDto);// Burada ise yeni eklenecek olan bir veriyi json formatına dönüştürmemiz lazım. "SerializeObject" ile bu işlemi yaparız. oluşturduğumuz nesneyi bizim için Json string’e çevirdi.
            ...
            await client.PostAsync("http://localhost:12091/api/Contact", stringContent);// Ekleme yapabilmek için "PostAsync" metodunu kullanırız
